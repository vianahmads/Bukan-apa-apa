...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = -327.04293823242, y = -144.70381164551, z = 38.059967041016},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('Bengkel Mekanik'),
		Hint  = _U('press_custom')
	},

	ls2 = {
		Pos   = { x = -325.23480224609, y = -138.2353515626, z = 38.009666442871},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('Bengkel Mekanik'),
	...
	ls3 = {
		Pos   = { x = -336.4284362793, y = -135.36978149414, z = 38.009666442871},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('Bengkel Mekanik'),
	...
	ls4 = {
		Pos   = { x = -1164.5042724609, y = -1688.5023193359, z = 3.8489130020142},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('Bengkel Car Dealer'),
		Hint  = _U('press_custom')
	},
