...
Citizen.CreateThread(function()
  while true do
   ...
   if IsControlPressed(0,  Keys['=']) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
