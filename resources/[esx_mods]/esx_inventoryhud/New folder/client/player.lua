...
AddEventHandler("esx_inventoryhud:openPlayerInventory", function(target, playerName)
    ...
    if PlayerData.job and PlayerData.job.name == 'police' or PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'lazy' or PlayerData.job.name == 'mafia' or PlayerData.job.name == 'cartel' then
        targetPlayer = target
