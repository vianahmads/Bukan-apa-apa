...
Config.DamageMult = 100 -- Higher Number = Higher Repair Price.

Config.CarPoundPrice      = 10000 -- Car Pound Price.
...
Config.DeleteMarker = {
	...
	x = 7.0, y = 7.0, z = 1.5  -- Big Size Circle
}
...
Config.CarGarages = {
	...
	Garage_Peace = {
		GaragePoint = { x = -1043.3024902344, y = -1399.9296875, z = 4.5 },
		SpawnPoint = { x = -1052.037109375, y = -1398.2756347656, z = 4.5, h = 73.7174148 },
		DeletePoint = { x = -1061.1292724609, y = -1448.1890869141, z = 4.5 }
	}
}
