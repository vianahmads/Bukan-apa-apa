...
files {
    'crf_data/carvariations.meta',
    'crf_data/carcols.meta',
    'crf_data/handling.meta',
    'crf_data/vehicles.meta',
...
data_file 'HANDLING_FILE' 'crf_data/handling.meta'
data_file 'CARCOLS_FILE' 'crf_data/carcols.meta'
data_file 'VEHICLE_VARIATION_FILE' 'crf_data/carvariations.meta'
data_file 'VEHICLE_METADATA_FILE' 'crf_data/vehicles.meta'
