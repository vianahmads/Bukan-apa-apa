TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "IN GAME SPEAK (TEST SERVER)",
		TSPassword = "221133789", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "18.141.156.24", -- TeamSpeak server address to be displayed on blocking screen
